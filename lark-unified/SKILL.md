---
name: lark-unified
description: "统一的飞书 CLI 套件，涵盖消息、文档、协作、日程等能力。提供 200+ 命令，覆盖 11 个业务域，包括即时消息（IM）、云文档、电子表格、多维表格、日历、邮件、待办、知识库、视频会议和自定义集成。适用于通过 CLI 操作飞书或需要了解飞书 API 能力的场景：收发消息、管理文档和文件、创建电子表格、管理待办和日程、搜索会话、构建自定义工作流或访问任何飞书业务应用。"
